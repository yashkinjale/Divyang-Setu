...
const DonorNavbar = () => {
  ...
  const drawer = (
    <Box sx={{ width: 250 }}>
      <Box sx={{ p: 2, textAlign: 'center', bgcolor: theme.palette.primary.main, color: 'white' }}>
                ...
                {navigationItems.map((item) => (
                  <Button
                    ...
                    sx={{
                      ...
                      bgcolor: location.pathname === item.path ? theme.palette.primary.light + '20' : 'transparent',
                      '&:hover': {
